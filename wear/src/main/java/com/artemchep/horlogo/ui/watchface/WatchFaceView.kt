...
class WatchFaceView @JvmOverloads constructor(
    ...
    override fun onFinishInflate() {
        ...
        WatchFaceService.COMPLICATIONS.forEach { id ->
    ...
    private fun findComplicationViewById(id: Int) = when (id) {
        WatchFaceService.COMPLICATION_FIRST -> complication1TextView
        WatchFaceService.COMPLICATION_SECOND -> complication2TextView
        WatchFaceService.COMPLICATION_THIRD -> complication3TextView
        WatchFaceService.COMPLICATION_FOURTH -> complication4TextView
